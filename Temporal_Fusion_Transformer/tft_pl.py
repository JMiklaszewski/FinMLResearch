...
class TemporalFusionTransformer(pl.LightningModule):
    ...
    def forward(self, batch):
        ...
        if self.task_type == 'classification':
            predicted_quantiles = nn.Softmax(dim=2)(predicted_quantiles)
        # Dimensions:
    ...
    def configure_optimizers(self):
        ' This is a pytorch-lightning alternative for specyfing optimizer'
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        batch = {v:i for v,i in zip(vars, train_batch)}
    ...
    def validation_step(self, val_batch, batch_idx):
        ' This function allows us to validate the pl model with pl.Trainer(model, train_loader, validation_loader)'

        vars = ['static_feats_numeric', 'static_feats_categorical',
        'historical_ts_numeric', 'historical_ts_categorical',
        'future_ts_numeric', 'future_ts_categorical', 'target']

        batch = {v:i for v,i in zip(vars, val_batch)}
